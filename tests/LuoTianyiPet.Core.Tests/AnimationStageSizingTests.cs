...
public sealed class AnimationStageSizingTests
{
    ...
    public void UserScaleDefinesStageAndIslands(int scale, double width, double height, double track)
    {
        ...
        Assert.True(size.Accessories.MusicIslandScale * AccessorySizingResolver.MusicIslandNaturalWidth <=
            size.Width - AccessorySizingResolver.HorizontalInset);
    }
