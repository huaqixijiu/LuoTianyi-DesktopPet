...
internal sealed partial class PlannerWindow
{
    ...
    {
        _editing=true;StackPanel panel=new(){Width=640};DockPanel head=new();
        ...
        StackPanel nameBox=BoxWith(name,nameCount);
        ...
        TextBox notes=new(){Name="ReminderNotes",Text=legacyNotes,AcceptsReturn=true,TextWrapping=TextWrapping.Wrap,MinHeight=80,MaxHeight=170,VerticalScrollBarVisibility=ScrollBarVisibility.Auto};
        TextBlock notesCount=Counter($"{notes.Text.Length} 字");notes.TextChanged+=(_,_)=>notesCount.Text=$"{notes.Text.Length} 字";
        StackPanel notesBox=BoxWith(notes,notesCount);
        ...
        void Update()
        {
            ...
            specified.Background=!relative?PlannerTheme.Accent:Brushes.White;specified.Foreground=!relative?Brushes.White:PlannerTheme.Ink;specified.BorderBrush=!relative?PlannerTheme.Accent:PlannerTheme.Line;specified.FontWeight=!relative?FontWeights.SemiBold:FontWeights.Normal;
            countdown.Background=relative?PlannerTheme.Accent:Brushes.White;countdown.Foreground=relative?Brushes.White:PlannerTheme.Ink;countdown.BorderBrush=relative?PlannerTheme.Accent:PlannerTheme.Line;countdown.FontWeight=relative?FontWeights.SemiBold:FontWeights.Normal;
